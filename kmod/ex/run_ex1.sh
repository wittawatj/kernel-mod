...
screen -S ex1_kmod -X screen -t tab0 bash -lic "python ex1_vary_n.py stdnormal_shift_d1"
screen -S ex1_kmod -X screen -t tab0 bash -lic "python ex1_vary_n.py stdnormal_h0_d5"
